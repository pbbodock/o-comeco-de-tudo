...
Ainda é possível mesclar itálico e negrito, basta adicionar as duas sintaxe à palavra considerando que a última sintaxe aberta deve ser a primeira a ser encerrada \(ex.:\*\*\_ BODOCK\_\*\* produz esse resultado **_BODOCK_**\) fechar a sintaxe na sequência correta resultará em um formatação diferente da esperada \(ex.:\(ex.:\*\*\_ BODOCK\*\*\_ produz esse resultado **_BODOCK**_**\).  
...
Uma outra forma é simplesmente indo para a linha seguinte.
